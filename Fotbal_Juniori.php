...
<div class="container">
    ...
    <div class="containerBody">
        ...
        <h1>Echipa de Fotbal Junior ( Academia Cojestenii )</h1>

        <div class="players">
            <?php
            $query = "SELECT * FROM football_club.team_members WHERE echipa='Fotbal Juniori' order by position asc";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "Nu există jucători în echipa de fotbal juniori.";
            }
            ?>
        </div>
    </div>
